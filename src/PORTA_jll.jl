...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import PORTA_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("c3fa2e09-48e0-5371-872a-ed3ac32dd1fc"))
platforms = [Pkg.Artifacts.unpack_platform(e, "PORTA", artifacts_toml) for e in artifacts["PORTA"]]
...
if best_platform === nothing
    @debug("Unable to load PORTA; unsupported platform $(triplet(platform_key_abi()))")
else
